<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Testimonials.aspx.vb" Inherits="SunduFront.Testimonials" %>
<!doctype html>
<html lang="zxx">
...
<body>
    ...
    <div class="review-area ptb-100">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-review-box" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                        ...
                        <p>Outstanding service! Sundus Exchange has simplified currency exchange for me. Their platform
                            is
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-review-box" data-aos="fade-up" data-aos-delay="60" data-aos-duration="600"
                        ...
                        <p>Impressive experience with Sundus Exchange! Their customer support is top-notch, and their
                            exchange rates are affodable, never disappoints.
                        </p>
                        <div class="reviewquote-image">
                            <img src="webassets/images/quote-icon.png" alt="image">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-review-box" data-aos="fade-up" data-aos-delay="70" data-aos-duration="700"
                        ...
                        <p>Sundus Exchange has exceeded my expectations! Their service is fast, reliable, and
                            user-friendly. I've had a great experience using their platform.</p>
                        <div class="reviewquote-image">
                            <img src="webassets/images/quote-icon.png" alt="image">
                        </div>
                        <div class="review-info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-review-box" data-aos="fade-up" data-aos-delay="70" data-aos-duration="700"
                        ...
                        <p>Sundus Exchange is integral to my business, providing a dependable platform with versatile
                            currency management. I wholeheartedly endorse their hassle-free international payment
                            solution.
                        </p>
                        <div class="reviewquote-image">
                            <img src="webassets/images/quote-icon.png" alt="image">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-review-box" data-aos="fade-up" data-aos-delay="70" data-aos-duration="700"
                        ...
                        <p>I'm impressed by the level of professionalism and efficiency of Sundus Exchange. Their
                            customer support is top-notch, and I feel confident using their services for my
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-review-box" data-aos="fade-up" data-aos-delay="70" data-aos-duration="700"
                        ...
                        <p>Using Sundus Exchange has made managing my finances so much easier. Their platform is
                            intuitive, and I appreciate the transparency they provide throughout the transaction
                            process.
                        </p>
                        <div class="reviewquote-image">
                            <img src="webassets/images/quote-icon.png" alt="image">
            ...
            <div class="pagination-area">
                <a href="Testimonials.aspx" class="prev page-numbers"><i class="ri-arrow-left-s-line"></i></a>
                <span class="page-numbers current" aria-current="page">1</span>
                <a href="Testimonials.aspx" class="page-numbers">2</a>
                <a href="Testimonials.aspx" class="page-numbers">3</a>
                <a href="Testimonials.aspx" class="next page-numbers"><i class="ri-arrow-right-s-line"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="review-area bg-F4F5F5 ptb-100">
        <div class="container">
            <div class="section-title">
                <span>Our Review</span>
                <h2>More Than 4,288 Happy Customers Trust Our Currency Exchange Services</h2>
            </div>
            <div class="review-slides-two owl-carousel owl-theme">
                ...
                <div class="single-review-card" data-aos="fade-up" data-aos-delay="60" data-aos-duration="600"
                    ...
                    <p>Sundus Exchange simplifies international payments for businesses. Their reliable platform lets
                        you manage multiple
                        currencies with ease, making them a great choice for hassle-free international transactions.</p>
                    <div class="review-info">
