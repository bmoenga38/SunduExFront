<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="HelpCenter.aspx.vb" Inherits="SunduFront.HelpCenter" %>
        ...
        <div class="container">
            <div class="help-center-box">
                ...
                <div class="help-image">
                    <img src="webassets/images/help.png" alt="image">
                </div>
                <div class="help-shape">
                    <img src="webassets/images/page-banner/shape.png" alt="image">
                </div>
                <div class="help-shape-2">
                    <img src="webassets/images/page-banner/shape-2.png" alt="image">
                </div>
                <div class="help-shape-3">
                    <img src="webassets/images/page-banner/shape-3.png" alt="image">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="single-explore-card">
                        <div class="explore-content">
                            <div class="explore-image">
                                <img src="webassets/images/explore/explore-1.png" alt="image">
                            </div>
                            <div class="single-features-box" data-aos="fade-up" data-aos-delay="50"
                                ...
                                <p>Sundus Exchange provides intuitive tools for effective account management,
                                    facilitating transaction tracking, balance
                                    monitoring, and overall financial oversight.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6">
                    <div class="single-explore-card">
                        <div class="explore-content">
                            <div class="explore-image">
                                <img src="webassets/images/explore/explore-2.png" alt="image">
                            </div>
                            <h3>Receiving Money</h3>
                            <p>Sundus Exchange simplifies the process of receiving money from anywhere in the world.
                                Whether it's payments from clients or transfers from family members abroad, our platform
                                ensures quick and secure transactions.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6">
                    <div class="single-explore-card">
                        <div class="explore-content">
                            <div class="explore-image">
                                <img src="webassets/images/explore/explore-3.png" alt="image">
                            </div>
                            <h3>Sundus Card</h3>
                            <p>Simplifying financial management while on the move.
                                Seamlessly integrated with the Sundus Exchange platform, it allows effortless
                                transaction tracking and spending control.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6">
                    <div class="single-explore-card">
                        <div class="explore-content">
                            <div class="explore-image">
                                <img src="webassets/images/explore/explore-4.png" alt="image">
                            </div>
                            <h3>Holding Money</h3>
                            <p>Sundus Exchange prioritizes a reliable infrastructure and stringent protocols in place,
                                users can confidently manage their finances knowing that their money is protected.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6">
                    <div class="single-explore-card">
                        <div class="explore-content">
                            <div class="explore-image">
                                <img src="webassets/images/explore/explore-5.png" alt="image">
                            </div>
                            <h3>Sending Money</h3>
                            <p>Whether it's for personal or business purposes, you can trust Sundus Exchange to
                                facilitate seamless transactions, ensuring your money reaches its destination swiftly
                                and securely.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="single-explore-card">
                        <div class="explore-content">
                            <div class="explore-image">
                                <img src="webassets/images/explore/explore-6.png" alt="image">
                            </div>
                            <h3>Our Business</h3>
                            <p>The platform enables secure and convenient fund transfers for personal or business
                                purposes, ensuring seamless
                                transactions with swift and secure delivery of funds.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="overview-content" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                ...
                <ul class="overview-btn-group">
                    <li>
                        <a href="ContactHQ.aspx" class="default-btn">Contact Headquarters</a>
                    </li>
                    <li>
