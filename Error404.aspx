<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Error404.aspx.vb" Inherits="SunduFront.Error404" %>
    ...
    <div class="error-area ptb-100">
        <div class="container">
            <div class="error-content">
                <img src="webassets/images/error.png" alt="image">
                <h3>Error 404 : Page Not Found</h3>
                <p>The page you are looking for might have been removed had its name changed or is temporarily
                    unavailable.</p>
                <a href="index.aspx" class="default-btn">Back to Homepage</a>
            </div>
        </div>
    </div>
