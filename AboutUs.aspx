<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AboutUs.aspx.vb" Inherits="SunduFront.AboutUs" %>
...
<head>
    ...
    <link rel="icon" type="svg" href="webassets/images/sundus.svg">
</head>
    ...
    <div class="partner-area ptb-100">
        <div class="container">
            <div class="partner-title">
                <h3>Used By 1k+ Businesses Of All Shapes And Sizes</h3>
            </div>
            <div class="partner-slides owl-carousel owl-theme">
                <div class="partner-image">
                    <a href="AboutUs.aspx"><img src="webassets/images/partner/partner-1.png" alt="image"></a>
                </div>
                <div class="partner-image">
                    <a href="AboutUs.aspx"><img src="webassets/images/partner/partner-2.png" alt="image"></a>
                </div>
                <div class="partner-image">
                    <a href="AboutUs.aspx"><img src="webassets/images/partner/partner-3.png" alt="image"></a>
                </div>
                <div class="partner-image">
                    <a href="AboutUs.aspx"><img src="webassets/images/partner/partner-4.png" alt="image"></a>
                </div>
                <div class="partner-image">
                    <a href="AboutUs.aspx"><img src="webassets/images/partner/partner-5.png" alt="image"></a>
                </div>
                <div class="partner-image">
                    <a href="AboutUs.aspx"><img src="webassets/images/partner/partner-6.png" alt="image"></a>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="paiement-content" data-aos="fade-right" data-aos-delay="50" data-aos-duration="500"
                        data-aos-once="true">
                        <span>Payment Services Worldwide</span>
                        <h3>Easily Grow Your Business Save More Money</h3>
                        <p>Experience streamlined operations and cost savings with our services.</p>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="paiement-image" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                        data-aos-once="true">
                        <img src="webassets/images/paiement.png" alt="image">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="review-area bg-F4F5F5 ptb-100">
        <div class="container">
            <div class="section-title">
                ...
                <h2>More Than 4228 Happy Customers Trust Our Currency Exchange Services</h2>
            </div>
            <div class="review-slides-two owl-carousel owl-theme">
                <div class="single-review-card" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                    ...
                    <div class="review-info">
                        <img src="webassets/images/review/review-1.png" alt="image">
                        <h3>Thomoson Piterson</h3>
                        <span>Global Transaction Pioneer</span>
                    </div>
                ...
                <div class="single-review-card" data-aos="fade-up" data-aos-delay="60" data-aos-duration="600"
                    ...
                    <p>Impressive experience with Sundus Exchange! Their customer support is top-notch, and their
                        exchange rates are competitive. I've been using their services for years and have never been
                        disappointed.
                    </p>
                    <div class="review-info">
                        <img src="webassets/images/review/review-2.png" alt="image">
                        <h3>Maxwel Warner</h3>
                        <span>Sundus Exchange Customer</span>
                    </div>
                    <div class="reviewquote-image">
                        <img src="webassets/images/quote-icon.png" alt="image">
                    </div>
            ...
            <div class="review-optional-content">
                <p>But don’t just take our word for it - check out what our customers have to say about their experience
                    with us: <b>Excellent</b> <span>Based on 20,343 reviews</span></p>
            </div>
        </div>
        <div class="review-shape">
            <img src="webassets/images/review/shape-1.png" alt="image">
        </div>
        <div class="review-shape-2">
            <img src="webassets/images/review/shape-2.png" alt="image">
        </div>
    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="app-content" data-aos="fade-right" data-aos-delay="50" data-aos-duration="500"
                        ...
                        <p>Discover everything you need with our Sundus Exchange mobile app.</p>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="app-image" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                        data-aos-once="true">
                        <img src="webassets/images/app.png" alt="image">
    ...
    <!-- <div class="overview-area ptb-100">
        <div class="container">
            <div class="overview-content" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                ...
                <h3>Headquarters</h3>
                <p> a palce that ill be given</p>
                <br>
                <P>nrinz</P>
                <br>
                <h3>Our other Branch</h3>
                <p> a palce that ill be given</p>
                <P>nrinz</P>


                 <ul class="overview-btn-group">
                    <a href="contact-center.html" class="optional-btn">Contact Us</a>
                </ul> 
            </div>
        </div>
    ...
    <div class="overview-area ptb-100">
        <div class="container">
            <div class="overview-content" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                ...
                <ul class="overview-btn-group">
                    <li>
                        <a href="ContactHQ.aspx" class="default-btn">Contact the Headquarters</a>
                    </li>
                    <li>
                        <a href="ContactHQ.aspx" class="optional-btn">Contact Branch</a>
                    </li>
                </ul>
            </div>
        </div>
