<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Blog.aspx.vb" Inherits="SunduFront.Blog" %>
    ...
    <div class="blog-area pt-100 pb-100">
        <div class="container">
            <div class="section-title">
                ...
                <h2>Get Up To Dates With Our Latest Blog And Banking News</h2>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-card">
                        <div class="blog-image">
                            <a href="BlogDetails.aspx"><img src="webassets/images/blog/blog-1.jpg" alt="image"></a>
                            <div class="date">May 01,2024</div>
                        </div>
                        <div class="blog-content">
                            <h3>
                                <a href="BlogDetails.aspx">The Security Risks Of Changing Package Owners</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisc elit vitae commodo nunc vel quis edout
                                habitant libero text ipsum amet.</p>
                            <a href="BlogDetails.aspx" class="blog-btn">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-card">
                        <div class="blog-image">
                            <a href="BlogDetails.aspx"><img src="webassets/images/blog/blog-2.jpg" alt="image"></a>
                            <div class="date">May 07,2024</div>
                        </div>
                        <div class="blog-content">
                            <h3>
                                <a href="BlogDetails.aspx">You Can Trust Me And Business With Together</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisc elit vitae commodo nunc vel quis edout
                                habitant libero text ipsum amet.</p>
                            <a href="BlogDetails.aspx" class="blog-btn">Read More</a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-card">
                        <div class="blog-image">
                            <a href="BlogDetails.aspx"><img src="webassets/images/blog/blog-3.jpg" alt="image"></a>
                            <div class="date">May 17, 2024</div>
                        </div>
                        <div class="blog-content">
                            <h3>
                                <a href="BlogDetails.aspx">Consumer Expectations For Experience In The Climate</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisc elit vitae commodo nunc vel quis edout
                                habitant libero text ipsum amet.</p>
                            <a href="BlogDetails.aspx" class="blog-btn">Read More</a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-card">
                        <div class="blog-image">
                            <a href="BlogDetails.aspx"><img src="webassets/images/blog/blog-4.jpg" alt="image"></a>
                            <div class="date">May 18, 2024</div>
                        </div>
                        <div class="blog-content">
                            <h3>
                                <a href="BlogDetails.aspx">When Hobby, Passion And Profession One And The Same</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisc elit vitae commodo nunc vel quis edout
                                habitant libero text ipsum amet.</p>
                            <a href="BlogDetails.aspx" class="blog-btn">Read More</a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-card">
                        <div class="blog-image">
                            <a href="BlogDetails.aspx"><img src="webassets/images/blog/blog-5.jpg" alt="image"></a>
                            <div class="date">May 19, 2024</div>
                        </div>
                        <div class="blog-content">
                            <h3>
                                <a href="BlogDetails.aspx">Why You Should Hire A Lawyer To Prepare Your Privacy
                                    Policy</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisc elit vitae commodo nunc vel quis edout
                                habitant libero text ipsum amet.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-card">
                        <div class="blog-image">
                            <a href="BlogDetails.aspx"><img src="webassets/images/blog/blog-6.jpg" alt="image"></a>
                            <div class="date">May 20, 2024</div>
                        </div>
                        <div class="blog-content">
                            <h3>
                                <a href="BlogDetails.aspx">5 Things That Every Startup Needs To Do To Succeed</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisc elit vitae commodo nunc vel quis edout
                                habitant libero text ipsum amet.</p>
                            <a href="BlogDetails.aspx" class="blog-btn">Read More</a>
            ...
            <div class="pagination-area">
                <a href="Blog.aspx" class="prev page-numbers"><i class="ri-arrow-left-s-line"></i></a>
                <span class="page-numbers current" aria-current="page">1</span>
                <a href="Blog.aspx" class="page-numbers">2</a>
                <a href="Blog.aspx" class="page-numbers">3</a>
                <a href="Blog.aspx" class="next page-numbers"><i class="ri-arrow-right-s-line"></i></a>
            </div>
        </div>
    </div>
